...
def mcts_strategy(initial_state, player, number_of_iteration, get_result:Callable, get_all_posible_moves:Callable, change_player:Callable, board_move:Callable, get_move_from_strategy:Callable,  max_depth:int = -1):
