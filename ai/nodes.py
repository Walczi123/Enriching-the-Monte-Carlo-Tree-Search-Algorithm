...
class RAVENodev2:
    ...
    def add_child(self, move, state):
        ...
        if all_posible_moves == []:
            ...
            all_posible_moves = self.get_all_posible_moves(state, p)
            if all_posible_moves != []:
                child = RAVENodev2(self, move, state, p, self.get_result, self.get_all_posible_moves, self.change_player, all_posible_moves)
            else :
                child = RAVENodev2(self, move, state, player, self.get_result, self.get_all_posible_moves, self.change_player, all_posible_moves)
        else:
            child = RAVENodev2(self, move, state, player, self.get_result, self.get_all_posible_moves, self.change_player, all_posible_moves = all_posible_moves)
