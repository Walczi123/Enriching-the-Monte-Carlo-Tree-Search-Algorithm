...
OTHELLO_PLAYERS = [
    ...
    MCTSStrategy_Player(mobility_strategy, 10000),
    MCTS_Player(10000),
    MCTSSwitchingStrategy_Player([random_strategy, mobility_strategy_vs,mobility_strategy,mapbaseothello_strategy,greedyhive_strategy,evaluatehive_strategy], 10000),
    MCTSRAVE_Player(10000),
    AlphaBeta_Player(10),
    Strategy_Player(random_strategy),
    Strategy_Player(greedyhive_strategy),
