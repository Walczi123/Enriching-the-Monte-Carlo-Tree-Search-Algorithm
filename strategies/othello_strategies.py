...
def mapbaseothello_strategy(moves, board_move, get_all_posible_moves, player, change_player):
    usefull = [[],[],[],[],[]]
    for x,y in moves:
        # corner places
        if (x % 7 == 0 and y % 7 == 0):
...
def greedyothello_strategy(moves, board_move, get_all_posible_moves, player, change_player):
    usefull = [[],[],[],[],[]]
    for x,y in moves:
        # corner places
        if (x % 7 == 0 and y % 7 == 0):
